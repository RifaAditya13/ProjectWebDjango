...
class CustomUserManager (BaseUserManager):
    def _create_user(self, email, name, phone, is_admin, is_staff, is_active, status, password, **extra_fields):
        ...
        user = self.model(email = email, name = name, password = password, phone = phone, is_admin = is_admin, is_staff = is_staff, status = status, **extra_fields)
    ...
    def create_user (self, email, name, phone, is_admin, is_staff, is_active, status, password = None, **extra_fields):
        return self._create_user(email, name, phone, is_admin, is_staff, is_active, status, password = None, **extra_fields)

    def create_superuser(self, name, email, phone, is_admin, is_staff, is_active, status, password = None, **extra_fields):
